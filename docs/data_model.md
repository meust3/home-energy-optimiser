...
UTC timestamp contract on PostgreSQL and SQLite.

The at-home column is the only location-derived value. No VIN, coordinate, device
attribute, GPS history, or named journey field exists. Raw vehicle battery power is
not direct charger AC power and never populates or replaces `ev_power_w`.
